...
cnt=1;%TOA&AOA求解
for i=1:1001
    Sol=Location_Q2([Local(4,:)+v(4,:)*0.01*(i-1),Len_TOA(i,4)+45,Sig(i,6:7)]);
...
%ylabel('y/m')
%zlabel('z/m')
%saveas(gcf,'Q3_trace2.jpg', 'jpeg')

 % 定义GIF文件名 
 figname = 'Q3.trace2.gif';
 % 创建一个循环，生成动画的每一帧
 for i = 1:20:1001
     % 更新图形数据
